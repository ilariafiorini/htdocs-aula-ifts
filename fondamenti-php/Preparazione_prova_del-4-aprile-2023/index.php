...
<body>
    ...
    <hr><br>
    <hr>
    <h3>Punto 0 - Popolazione della tabella (facoltativa)</h3>
    <hr><br>
    
    <p> Agiungi un record alla tabella utenti - Senza icona e CV che sono campi opzionali</p><br>

    <form action="popola_tabella.php" method="POST">
