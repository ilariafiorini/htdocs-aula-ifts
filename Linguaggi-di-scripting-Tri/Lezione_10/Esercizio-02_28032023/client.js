...
function getHttp() {
    return new Promise(
        function (resolve, reject) {
            ...
            xhr.open("GET", "https://dev.entrainhotel.com/wp-json/wao-portali/v1/mappaOfferta?pagina=&per_page=-1&trattamenti=&categorie_struttura=&servizi=&eventi=&periodi=&speciali=&localita=&data_arrivo=&data_partenza=&family=&bnb=");
            xhr.send();
        }
    );
}
